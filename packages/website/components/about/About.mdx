...
  
# advisor services (generally including consulting services)
...
For example, the open source agreement of [this site](https://github.com/WeFoxTech/wefox-site) is [CC by-nc-sa 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode).